...
$id=$_POST['id'];
$name=$_POST['itemname'];
$description=addslashes($_POST['itemdes']);
...
if(move_uploaded_file($file_loc,$folder.$date.".png"))
    ...
    $image="assets/images/ProductImage/product/".$new_file;
		$sql = "UPDATE items SET name='$name',description='$description',price='$price',discount='$discount',attribute='$attribute', image='$image'   WHERE  id='$id' ";
    ...
    $error="Something went wrong. Please try again";
		...
		$sql = "UPDATE items SET name='$name',description='$description',price='$price',discount='$discount',attribute='$attribute'   WHERE  id='$id' ";
    print_r($sql);
    die();
    $query = $dbh->prepare($sql);
    if($query->execute())
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <?php $sql = "SELECT items.*, category.category FROM items INNER JOIN category ON items.category_id=category.id";
                        $query = $dbh -> prepare($sql);
                        $query->execute();
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="../<?php echo htmlentities($result->image);?>" style="width:50px;"/>
                        </td>
                        <td>
                        ...
                        <td>
                          <?php echo htmlentities($result->prepareTime);?> 
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document" style="height: 100%; padding-top: 10%;">
          <div class="modal-content">
            ...
            <div class="modal-body">
                   ...
                   <div><img id="catImg" src="" alt="" width="100" height="100"></div>
