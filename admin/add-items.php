...
$sql="INSERT INTO items(name,category_id,description,price,discount,attribute,image,homepage) VALUES(:name,:category_id,:description,:price,:discount,:attribute,:image,:homepage)";
...
<div class="col-sm-4">
<input type="number" name="itemprice" class="form-control" required placeholder="Per gm/kg/l/pack">
</div>
<label class="col-sm-2 control-label">Discount Price<span style="color:red"></span></label>
<div class="col-sm-4">
   <input type="number" name="discount" class="form-control"  placeholder="Per gm/kg/l/pack">
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label">Attributes(gm/kg/l/pack)<span style="color:red">*</span></label>
<div class="col-sm-4">
   <input type="text" name="attribute" class="form-control" required  placeholder="gm/kg/l/pack">
</div>
